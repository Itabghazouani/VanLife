import {
  ...
  getModularInstance,
  registerVersion
} from "./chunk-M2NWWER5.js";
import "./chunk-5WRI5ZAA.js";

// node_modules/.pnpm/@firebase+firestore@4.7.3_@firebase+app@0.10.12/node_modules/@firebase/firestore/dist/lite/index.browser.esm2017.js
var User = class {
  constructor(t) {
    this.uid = t;
  }
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(t = Promise.resolve()) {
    this.yt = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.wt = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.gt = [], // visible for testing
    this.Ft = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.vt = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Dt = false, // List of TimerIds to fast-forward delays for.
    this.bt = [], // Backoff timer used to schedule retries for retryable operations
  ...
  enqueue(t) {
    ...
    return this.Ot(() => this.wt && this.Dt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  async qt() {
    if (0 !== this.yt.length) {
      ...
      this.yt.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  Ot(t) {
    const e = this.St.then(() => (this.vt = true, t().catch((t2) => {
      this.Ft = t2, this.vt = false;
      const e2 = (
        /**
   ...
   */
  Qt(t) {
    for (const e of this.gt) if (e.timerId === t) return true;
    return false;
  }
  /**
  ...
  Lt(t) {
    return this.$t().then(() => {
      this.gt.sort((t2, e) => t2.targetTimeMs - e.targetTimeMs);
      for (const e of this.gt) if (e.skipDelay(), "all" !== t && e.timerId === t) break;
      return this.$t();
    });
  }
  /**
